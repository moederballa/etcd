...
import (
	...
	"github.com/moederballa/etcd/etcdserver/api/v2http"
	"github.com/moederballa/etcd/etcdserver/api/v2v3"
	...
	runtimeutil "github.com/moederballa/etcd/pkg/runtime"
...
var plog = capnslog.NewPackageLogger("github.com/moederballa/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/moederballa/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
