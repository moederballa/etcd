...
[![GoDoc](https://godoc.org/github.com/moederballa/etcd/client?status.png)](https://godoc.org/github.com/moederballa/etcd/client)
...
```bash
go get github.com/moederballa/etcd/client
```
...
import (
	...
	"github.com/moederballa/etcd/client"
)
