...
import (
	...
	"github.com/moederballa/etcd/pkg/systemd"

	"github.com/moederballa/coreos/go-systemd/journal"
...
// Reference: https://github.com/moederballa/coreos/pkg/blob/master/capnslog/journald_formatter.go
