...
import (
	...
	"github.com/moederballa/etcd/etcdserver/api/snap/snappb"
	pioutil "github.com/moederballa/etcd/pkg/ioutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/moederballa/etcd", "snap")
